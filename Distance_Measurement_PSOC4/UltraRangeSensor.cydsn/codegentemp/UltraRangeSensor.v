// ======================================================================
// UltraRangeSensor.v generated from TopDesign.cysch
// 03/29/2020 at 19:43
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=2, PWMCountPresent=true, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=2, TCCapturePresent=false, TCCompare=2000, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=0, TCCountingModes=0, TCCountMode=3, TCCountPresent=true, TCInterruptMask=1, TCPeriod=4000, TCPrescaler=4, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=1, TCReloadPresent=false, TCRunMode=0, TCStartMode=3, TCStartPresent=true, TCStopMode=1, TCStopPresent=true, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=true, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=true, TermVisibility_stop=true, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer, CY_INSTANCE_SHORT_NAME=Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer, )
...
module BLE_v3_63_3 (
	...
	cy_clock_v1_0
		#(.id("8ec9db6c-aad0-443c-8970-7d07d4044c9b/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("11cc1053-2b03-46e3-b8ce-6798fbdae1ea"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Blauw_net;
	wire [0:0] tmpFB_0__Blauw_net;
	wire [0:0] tmpIO_0__Blauw_net;
	wire [0:0] tmpINTERRUPT_0__Blauw_net;
	electrical [0:0] tmpSIOVREF__Blauw_net;

	cy_psoc3_pins_v1_10
		#(.id("acf19f8b-cd41-4395-a628-60629072ee5c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Blauw
		 (.oe(tmpOE__Blauw_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Blauw_net[0:0]}),
		  .io({tmpIO_0__Blauw_net[0:0]}),
		  .siovref(tmpSIOVREF__Blauw_net),
		  .interrupt({tmpINTERRUPT_0__Blauw_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Blauw_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Rood_net;
	wire [0:0] tmpFB_0__Rood_net;
	wire [0:0] tmpIO_0__Rood_net;
	wire [0:0] tmpINTERRUPT_0__Rood_net;
	electrical [0:0] tmpSIOVREF__Rood_net;

	cy_psoc3_pins_v1_10
		#(.id("53dc6036-c8ce-4ca9-8d09-8d0fd3b6a0fc"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Rood
		 (.oe(tmpOE__Rood_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Rood_net[0:0]}),
		  .io({tmpIO_0__Rood_net[0:0]}),
		  .siovref(tmpSIOVREF__Rood_net),
		  .interrupt({tmpINTERRUPT_0__Rood_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rood_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
