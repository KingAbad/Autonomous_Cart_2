...
#define CYBLE_ULTRARANGESENSOR_SERVICE_INDEX   (0x00u) /* Index of UltrarangeSensor service in the cyBle_customs array */
#define CYBLE_ULTRARANGESENSOR_SENSOR_CHAR_INDEX   (0x00u) /* Index of Sensor characteristic */
#define CYBLE_ULTRARANGESENSOR_SENSOR_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
...
#define CYBLE_ULTRARANGESENSOR_SERVICE_HANDLE   (0x0010u) /* Handle of UltrarangeSensor service */
#define CYBLE_ULTRARANGESENSOR_SENSOR_DECL_HANDLE   (0x0011u) /* Handle of Sensor characteristic declaration */
#define CYBLE_ULTRARANGESENSOR_SENSOR_CHAR_HANDLE   (0x0012u) /* Handle of Sensor characteristic */
#define CYBLE_ULTRARANGESENSOR_SENSOR_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Custom Descriptor descriptor */
