    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'U', (uint8)'l', (uint8)'t', (uint8)'r', (uint8)'a', (uint8)'S', (uint8)'o', (uint8)'o', (uint8)'n',
    ...
    /* Custom Descriptor */
    0x00u, 0x00u, 0x8Eu, 0x51u, 0x0Du, 0xCAu, 0xBFu, 0x58u, 0xC7u, 0x85u, 0x33u, 0x4Du, 0xC5u, 0x45u, 0xE8u, 0xD7u,
    0x3Cu, 0x93u,
...
const uint8 cyBle_attUuid128[][16u] = {
    /* UltrarangeSensor */
    { 0x95u, 0x59u, 0x44u, 0x9Eu, 0xD2u, 0x35u, 0x62u, 0x90u, 0x1Du, 0x43u, 0x68u, 0x6Cu, 0x1Eu, 0x07u, 0x88u, 0x2Cu },
    /* Sensor */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x2Cu, 0x7Cu, 0x00u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* UltrarangeSensor UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Sensor UUID */
    { 0x0001u, (void *)&cyBle_attValues[31] }, /* Sensor */
    { 0x0002u, (void *)&cyBle_attValues[32] }, /* Custom Descriptor */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x13u] = {
    ...
    { 0x0012u, 0x7C2Cu /* Sensor                              */, 0x090A0101u /* rd,wr */, 0x0013u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0013u, 0xD7E8u /* Custom Descriptor                   */, 0x09000001u /*       */, 0x0013u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
};
