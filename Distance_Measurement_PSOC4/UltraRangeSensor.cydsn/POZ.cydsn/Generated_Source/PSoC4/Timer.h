...
#define Timer_PWM_COUNT_SIGNAL_MODE          (2lu)
...
/* Timer/Counter Mode */
#define Timer_TC_PERIOD_VALUE                (4000lu)
#define Timer_TC_COMPARE_VALUE               (1999lu)
